# Cryptography Fundamentals: Assignment Collection

This repository contains a comprehensive collection of seven cryptography assignments, spanning from basic bitwise operations to advanced asymmetric encryption algorithms. Each assignment provides both theoretical foundation and practical implementation details in various programming languages (C++, Java, and HTML).

## Table of Contents

1. [Bitwise Operations in Cryptography (C++)](#1-bitwise-operations-in-cryptography-c)
2. [Columnar Transposition Cipher (C++)](#2-columnar-transposition-cipher-c)
3. [Data Encryption Standard - DES (Java)](#3-data-encryption-standard---des-java)
4. [Advanced Encryption Standard - AES (Java)](#4-advanced-encryption-standard---aes-java)
5. [RSA Asymmetric Encryption (Java)](#5-rsa-asymmetric-encryption-java)
6. [Diffie-Hellman Key Exchange (HTML)](#6-diffie-hellman-key-exchange-html)
7. [MD5 Hashing (Java)](#7-md5-hashing-java)
8. [Comprehensive Summary and Interconnections](#comprehensive-summary-and-interconnections)

## 1. Bitwise Operations in Cryptography (C++)
...
## 2. Columnar Transposition Cipher (C++)
...
## 3. Data Encryption Standard - DES (Java)
...
## 4. Advanced Encryption Standard - AES (Java)
...
## 5. RSA Asymmetric Encryption (Java)
...
## 6. Diffie-Hellman Key Exchange (HTML)
...
- C++ compiler (for Assignments 1 and 2)
- Java Development Kit (JDK) 8 or higher (for Assignments 3, 4, 5, and 7)
- Web browser (for Assignment 6)
...
#### C++ Programs (Assignments 1 and 2)
```bash
g++ bitwise_crypto.cpp -o bitwise_crypto
./bitwise_crypto

g++ columnar_cipher.cpp -o columnar_cipher
./columnar_cipher
```

#### Java Programs (Assignments 3, 4, 5, and 7)
```bash
...
```bash
open diffie_hellman.html
```

## Additional Resources

For further exploration of cryptographic concepts and implementations, consider the following resources:
...
4. NIST Special Publications on Cryptography (https://csrc.nist.gov/publications)
5. Cryptography courses on platforms like Coursera and edX
...
- The cryptographic community for developing and documenting these foundational algorithms
- Academic institutions that continue to teach these important security concepts
- Open-source cryptographic libraries that make implementation accessible to students
